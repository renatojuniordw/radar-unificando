...
import {
  ...
  InputAdornment, TablePagination, Skeleton,
} from '@mui/material';
    ...
    <Paper variant="outlined" sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
          ...
          <Select
            value={filtroCargo}
            onChange={e => { setFiltroCargo(e.target.value); handleFilterChange({ cargo: e.target.value }); }}
      ...
      {loading ? (
        ...
        <>
          ...
          <TablePagination
            component="div" count={vagas.length} page={page}
