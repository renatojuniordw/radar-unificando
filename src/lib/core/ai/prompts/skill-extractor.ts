/**
 * Prompt de extração de skills dividido em system + user.
 * A separação reduz chain-of-thought em reasoning models.
 */

export const SKILL_EXTRACTOR_SYSTEM_PROMPT = `Você é um extrator de dados estruturados de currículos. Sua ÚNICA função é ler o currículo fornecido e retornar um objeto JSON válido com os campos especificados.
...
export const SKILL_EXTRACTOR_USER_PROMPT = `Extraia do currículo em markdown abaixo (o currículo pode estar em qualquer idioma):
...
/**
 * @deprecated Use SKILL_EXTRACTOR_SYSTEM_PROMPT + SKILL_EXTRACTOR_USER_PROMPT.
 * Mantido para backward compat com callers que passam prompt como string única.
 */
