...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/busca`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${base}/extensao`, lastModified, changeFrequency: "monthly", priority: 0.5 },
  ...
  COURSES.forEach((c) => c.skillTags.forEach((t) => skillSlugs.add(skillSlug(t))));
