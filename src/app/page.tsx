  ...
  return (
    <>
      ...
      >
        ...
        <Container
          maxWidth="xl"
          sx={{ py: { xs: 6, md: 8 }, position: "relative", zIndex: 1 }}
        >
        ...
        <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
          ...
          >
            {[
              {
                title: "100% GRATUITO",
                desc: "Sem taxas escondidas e sem limite de buscas para contas cadastradas.",
              },
              {
                title: "SEM CADASTRO OBRIGATÓRIO",
                desc: "Busque sem criar conta. Os resultados ficam salvos localmente no seu navegador.",
              },
              {
                title: "DADOS EM TEMPO REAL",
                desc: "Consulta direta em Gupy e InHire no momento da busca — sem base pré-carregada.",
              },
            ].map((item) => (
